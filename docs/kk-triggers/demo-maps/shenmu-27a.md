...
slug: demo-maps/shenmu-27a
description: 演示图 神墓27a 的完整 GUI 触发器代码
updated: 2026-06-01
---
...
动作
  ...
  ├─ ── 设置进攻怪技能---高难度 ──
  ├─ 设置 aJinGongGuaiHard[1] = Ainf
  ├─ 设置 aJinGongGuaiHard[2] = Ablo
  ...
  ├─ 设置 sXiongMao[23] = "|cffffcc00三清：富贵？仙人？听说你刚出道的时候过于犀利引得众生不平，现在被削成什么样了！！！|r"
  ├─ 设置 sXiongMao[24] = "|cffffcc00三清：你化的妆实在是黑不溜秋，让熊猫我大倒胃口。|r"
...
动作
  ...
  ├─ 显示文本→grpOnline: "TRIGSTR_5483"
  ├─ 显示文本→grpOnline: "TRIGSTR_5546"
  ├─ 显示文本→grpOnline: "TRIGSTR_5547"
  └─ 循环整数A 1→7
       ├─ 添加事件到 gg_trg_ExitCenimaMode: TriggerRegisterPlayerEventEndCinematic(玩家循环整数A)
       ├─ 添加事件到 gg_trg_BackBase: 玩家聊天(玩家循环整数A(), "hg", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_BackRevivePoint: 玩家聊天(玩家循环整数A(), "hr", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_MoveCase: 玩家聊天(玩家循环整数A(), "-h", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_RandomHero: 玩家聊天(玩家循环整数A(), "-suiji", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_NoTeleport: 玩家聊天(玩家循环整数A(), "-nt", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_TFHQ: 玩家聊天(玩家循环整数A(), "-tfhq", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_ShowWeaponKill: 玩家聊天(玩家循环整数A(), "-wq", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_OfflinePlayerControl: 玩家聊天(玩家循环整数A(), "-kz", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_ShowWangCaiKill: 玩家聊天(玩家循环整数A(), "-旺财加油", ChatMatchTypeExact)
       ├─ 添加事件到 gg_trg_PlayerLeft: TriggerRegisterPlayerEventLeave(玩家循环整数A())
       ├─ 添加事件到 gg_trg_MoneyTooMuch: TriggerRegisterPlayerStateEvent(玩家循环整数A(), PlayerStateGold, LimitOpGreaterThanOrEqual, 900000.00)
       ├─ 添加事件到 gg_trg_ChangeLeaderboardLumber: TriggerRegisterPlayerStateEvent(玩家循环整数A(), PlayerStateLumber, LimitOpGreaterThanOrEqual, 1.00)
       ├─ 添加事件到 gg_trg_ReviveHero: 玩家单位事件(玩家循环整数A(), 单位死亡)
       ├─ 添加事件到 gg_trg_tNJKL: 计时器到期(tNJKL[循环整数A])
       ├─ 设置玩家属性: 玩家循环整数A(), PlayerStateGold, 30000
       ├─ 设置玩家属性: 玩家循环整数A(), PlayerStateLumber, 20
       ├─ CreateFogModifierRectBJ: EnabledDisabledEnabled, 玩家循环整数A, FogStateVisible, gg_rct______________________u
       ├─ 设置玩家属性: 玩家循环整数A(), 人口上限, 5
       ├─ SetPlayerAbilityAvailable: 玩家循环整数A(), AIso, EnableDisableDisable
       ├─ SetPlayerAllianceStateBJ: 非玩家, 玩家循环整数A, AllianceSettingAllied
...
动作
  ...
  └─ DialogDisplay: Player00, dlgNanDu, ShowHideShow
```
...
动作
  ...
  └─ 循环整数A 1→20
       └─ 如果
            ...
            │    MultiboardSetTitleText: TopBoard, "神之墓地2.6D 难度" + (循环整数A转字符串)
            │    返回
            └─ 否则: (无)
```
...
动作
  ...
  ├─ 创建任务: QuestTypeReqDiscovered, "TRIGSTR_1012", "TRIGSTR_1013", ReplaceableTextures\CommandButtons\BTNDeathAndDecay.blp
  ├─ 创建任务: QuestTypeReqDiscovered, "TRIGSTR_1008", "TRIGSTR_1009", ReplaceableTextures\CommandButtons\BTNDeathAndDecay.blp
  ├─ 创建任务: QuestTypeReqDiscovered, "TRIGSTR_1014", "TRIGSTR_1015", ReplaceableTextures\CommandButtons\BTNDeathAndDecay.blp
  ├─ 创建任务: QuestTypeReqDiscovered, "TRIGSTR_4602", "TRIGSTR_4605", ReplaceableTextures\CommandButtons\BTNDeathAndDecay.blp
...
条件
  └─ 无
动作
  ├─ CreateMultiboardBJ: 5, 8, "神之墓地2.7A 难度" + (玩家科技等级(Rhme, 玩家9(灰))转字符串)
...
动作
  ...
  │    │    添加事件到 gg_trg_tBaoFengxue: 计时器到期(tBaoFengXue[玩家号((被贩卖单位()的所有者))])
...
动作
  ...
  │    │    添加事件到 gg_trg_tBaoFengxue: 计时器到期(tBaoFengXue[玩家号(触发玩家())])
  ...
  │    ├─ 条件: (uTemp类型ID) == N00U
  │    ├─ 则
  │    │    调整 触发玩家() 的 PlayerStateGold: -20000
  │    └─ 否则: (无)
  ├─ 如果
  │    ├─ 条件: (uTemp类型ID) == N00W
  │    ├─ 则
...
动作
  ...
  └─ 如果
       ...
       │    MultiboardSetTitleText: TopBoard, "神之墓地2.7A 难度提升" + 取子字符串(玩家聊天字符串(), 5, 7)
...
动作
  ...
  │    ├─ 则
  │    │    显示文本→grpOnline: (单位名:uPlayerHeros[玩家号(触发玩家())]) + "获取了天赋技能：" + "自己的天赋，悲催的娃。"
  │    └─ 否则
  ...
  └─ 如果
       ├─ 条件: 全部成立
       │    ├─ (uPlayerHeros[玩家号(触发玩家())]类型ID) == N00U
       │    ├─ (uPlayerHeros[玩家号(触发玩家())]类型ID) == N00W
       │    ├─ 随机[1~100] == 13
       ├─ 则
       │    如果
       │      ├─ 条件: 随机[1~2] == 2
       │      ├─ 则
       │      │    添加技能: uPlayerHeros[玩家号(触发玩家())], aTianFu[13]
       │      │    UnitMakeAbilityPermanent: uPlayerHeros[玩家号(触发玩家())], OnOffOn, aTianFu[13]
       │      │    显示文本→grpOnline: (单位名:uPlayerHeros[玩家号(触发玩家())]) + "获取了天赋技能：" + 技能名称(aTianFu[iTemp])
       │      │    设置 bTFHQ[玩家号(触发玩家())] = true
       │      └─ 否则
       │           添加技能: uPlayerHeros[玩家号(触发玩家())], aTianFu[14]
       │           UnitMakeAbilityPermanent: uPlayerHeros[玩家号(触发玩家())], OnOffOn, aTianFu[14]
       │           显示文本→grpOnline: (单位名:uPlayerHeros[玩家号(触发玩家())]) + "获取了天赋技能：" + 技能名称(aTianFu[iTemp])
       │           设置 bTFHQ[玩家号(触发玩家())] = true
       └─ 否则: (无)
```
...
动作
  ...
  │    └─ 移除 选取单位()
  ├─ 删除单位组 grpTemp
  ├─ 设置 grpTemp = 玩家符合条件的单位(触发玩家(), 布尔比较(单位类型判断(过滤单位(), 英雄), OperatorEqualENE, true))
  ├─ 单位组: 选取 grpTemp 中所有单位
...
动作
  └─ 如果
       ├─ 条件: 玩家在玩家组中((触发单位()的所有者), grpOnline) == TRUE
       ├─ 则
       │    如果
       │      ├─ 条件: (触发单位()类型ID) == E000
       │      ├─ 则
...
```text
触发器: xuanyuanfuhuo (剧情/任务) [✗]
───────────────────────────────────────────────────────
事件
  └─ 注册进入矩形区域事件(gg_rct__________ac)
条件
  └─ 无
动作
  └─ (无)
...
```text
触发器: fengduguicheng (剧情/任务) [✗]
───────────────────────────────────────────────────────
事件
  └─ 单位 gg_unit_unp2_0034 - 单位死亡
条件
  └─ 无
动作
  ├─ 销毁触发器(自身)
...
动作
  ...
  ├─ ForceAddPlayer: grpPlayerGroupTemp, (触发单位()的所有者)
  ├─ 电影模式: OnOffOn, grpPlayerGroupTemp
  ├─ TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Ecen_0088, "TRIGSTR_5228", SoundNull, "TRIGSTR_5229", AddSetToAdd, 0, WaitDontWait
  ├─ TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_5259", AddSetToAdd, 0, WaitDontWait
  ├─ TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Ecen_0088, "TRIGSTR_5260", SoundNull, "TRIGSTR_5261", AddSetToAdd, 0, WaitDontWait
  ├─ 如果
  │    ├─ 条件: 玩家科技等级(Rhme, 玩家9(灰)) OperatorGreater 30
  │    ├─ 则
  │    │    TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Ecen_0088, "TRIGSTR_4846", SoundNull, "TRIGSTR_4882", AddSetToAdd, 0, WaitDontWait
  │    │    添加物品: stel, 触发单位()
  │    └─ 否则
  │         TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Ecen_0088, "TRIGSTR_4582", SoundNull, "TRIGSTR_4583", AddSetToAdd, 0, WaitDontWait
  │         修改 触发单位() 的HeroStatStr: ModifyMethodAdd10000
  │         修改 触发单位() 的HeroStatAgi: ModifyMethodAdd10000
  │         修改 触发单位() 的HeroStatInt: ModifyMethodAdd10000
  ├─ TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Ecen_0088, "TRIGSTR_5167", SoundNull, "TRIGSTR_5170", AddSetToAdd, 0, WaitDontWait
  ├─ ForceClear: grpPlayerGroupTemp
  ├─ ForceAddPlayer: grpPlayerGroupTemp, (触发单位()的所有者)
  ├─ 电影模式: OnOffOff, grpPlayerGroupTemp
  └─ 添加物品: I054, 触发单位()
...
动作
  ...
  └─ 如果
       ...
       │             │      │    ForceAddPlayer: grpPlayerGroupTemp, (触发单位()的所有者)
       │             │      │    电影模式: OnOffOn, grpPlayerGroupTemp
       │             │      │    TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_u003_0122, "TRIGSTR_3850", SoundNull, "TRIGSTR_3870", AddSetToAdd, 0, WaitDontWait
       │             │      │    ForceClear: grpPlayerGroupTemp
       │             │      │    ForceAddPlayer: grpPlayerGroupTemp, (触发单位()的所有者)
       │             │      │    电影模式: OnOffOff, grpPlayerGroupTemp
       │             │      └─ 否则
       ...
       │             │           ForceClear: grpPlayerGroupTemp
       │             │           ForceAddPlayer: grpPlayerGroupTemp, (触发单位()的所有者)
       │             │           TransmissionFromUnitWithNameBJ: grpPlayerGroupTemp, gg_unit_u003_0122, "TRIGSTR_3912", SoundNull, "TRIGSTR_3913", AddSetToAdd, 0, WaitDontWait
       │             └─ 否则: (无)
       └─ 否则: (无)
```
...
条件
  ├─ 单位类型判断(触发单位(), 英雄) == TRUE
  └─ IsPlayerAlly((触发单位()的所有者), 玩家7(绿)) == TRUE
动作
...
条件
  ├─ 单位类型判断(触发单位(), 英雄) == TRUE
  ├─ 玩家在玩家组中((触发单位()的所有者), grpOffline) == TRUE
  └─ bSiWangJueDi == TRUE
动作
...
动作
  ...
  ├─ ── 召唤物科技  龙刀 十字架 贯穿 ──
  ├─ 如果
  │    ├─ 条件: 玩家在玩家组中((凶手单位()的所有者), grpOnline) == TRUE
  │    ├─ 则
  │    │    设置 iTemp = 玩家号((凶手单位()的所有者))
  ...
  │    │      │      │    ├─ 玩家在玩家组中((凶手单位()的所有者), grpOnline) == TRUE
  │    │      │      │    ├─ 任一成立
  │    │      │      ├─ 则
  ...
  │    │      │      │    电影模式: OnOffOn, grpOnline
  │    │      │      │    TransmissionFromUnitWithNameBJ: grpOnline, 凶手单位(), (单位名:凶手单位()), SoundNull, "TRIGSTR_3966", AddSetToAdd, 0, WaitDontWait
  │    │      │      │    电影模式: OnOffOff, grpOnline
  ...
  │    │      │    PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │      │    电影模式: OnOffOn, grpOnline
  │    │      │    TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Uclc_0123, "TRIGSTR_4475", SoundNull, "TRIGSTR_4476", AddSetToAdd, 0, WaitDontWait
  │    │      │    电影模式: OnOffOff, grpOnline
  │    │      │    ForForceMultiple: grpOnline
  │    │      │    返回
  │    │      └─ 否则
  │    │           PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │           电影模式: OnOffOn, grpOnline
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Uclc_0123, "TRIGSTR_4478", SoundNull, "TRIGSTR_4479", AddSetToAdd, 0, WaitDontWait
  │    │           电影模式: OnOffOff, grpOnline
  │    │           ForForceMultiple: grpOnline
  │    │           宣布失败: (uFuShenMoDi的所有者), "TRIGSTR_4481"
  │    │           返回
  │    └─ 否则: (无)
  ├─ ── 残 ──
  ├─ 如果
  ...
  │    │      │    PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │      │    电影模式: OnOffOn, grpOnline
  │    │      │    TransmissionFromUnitTypeWithNameBJ: grpOnline, 玩家9(灰), H009, "TRIGSTR_3953", pShuaGuai[44], SoundNull, "TRIGSTR_3954", AddSetToAdd, 0, WaitDontWait
  │    │      │    TransmissionFromUnitTypeWithNameBJ: grpOnline, 玩家9(灰), H009, "TRIGSTR_3957", pShuaGuai[44], SoundNull, "TRIGSTR_3958", AddSetToAdd, 0, WaitDontWait
  │    │      │    电影模式: OnOffOff, grpOnline
  ...
  │    │           PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │           电影模式: OnOffOn, grpOnline
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_3959", AddSetToAdd, 0, WaitDontWait
  │    │           电影模式: OnOffOff, grpOnline
  │    │           显示文本→grpOnline: "TRIGSTR_1951"
  │    │           PolledWait: 60.00
  │    │           ForForceMultiple: grpOnline
  │    │           返回
  │    └─ 否则: (无)
  ...
  │    │    PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │    电影模式: OnOffOn, grpOnline
  │    │    TransmissionFromUnitWithNameBJ: grpOnline, gg_unit_Uclc_0123, "TRIGSTR_3943", SoundNull, "TRIGSTR_3944", AddSetToAdd, 0, WaitDontWait
  │    │    电影模式: OnOffOff, grpOnline
  │    │    显示文本→grpOnline: "TRIGSTR_1942"
  │    │    设置 pTemp = (触发单位()的位置)
  ...
  │    │      │    PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │      │    电影模式: OnOffOn, grpOnline
  │    │      │    TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4325", AddSetToAdd, 0, WaitDontWait
  │    │      │    TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4326", AddSetToAdd, 0, WaitDontWait
  │    │      │    TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4327", AddSetToAdd, 0, WaitDontWait
  │    │      │    电影模式: OnOffOff, grpOnline
  ...
  │    │           PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
  │    │           电影模式: OnOffOn, grpOnline
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4318", AddSetToAdd, 0, WaitDontWait
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 凶手单位(), (单位名:凶手单位()), SoundNull, "TRIGSTR_4319", AddSetToAdd, 0, WaitDontWait
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4320", AddSetToAdd, 0, WaitDontWait
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 凶手单位(), (单位名:凶手单位()), SoundNull, "TRIGSTR_4321", AddSetToAdd, 0, WaitDontWait
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4322", AddSetToAdd, 0, WaitDontWait
  │    │           TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), (单位名:触发单位()), SoundNull, "TRIGSTR_4323", AddSetToAdd, 0, WaitDontWait
  │    │           电影模式: OnOffOff, grpOnline
  │    │           显示文本→grpOnline: "TRIGSTR_4324"
  │    │           PolledWait: 60.00
  │    │           ForForceMultiple: grpOnline
  │    │           返回
  │    └─ 否则: (无)
  ...
  └─ 如果
       ...
       │    PanCameraToTimed: 单位X坐标(触发单位()), 单位Y坐标(触发单位()), 0
       │    电影模式: OnOffOn, grpOnline
       │    TransmissionFromUnitWithNameBJ: grpOnline, 触发单位(), "TRIGSTR_4473", SoundNull, "TRIGSTR_4467", AddSetToAdd, 0, WaitDontWait
       │    电影模式: OnOffOff, grpOnline
       │    ForForceMultiple: grpOnline
       │    宣布失败: (触发单位()的所有者), "TRIGSTR_4474"
       │    返回
       └─ 否则: (无)
```
...
动作
  ...
  └─ 如果
       ...
       │    ├─ 单位类型判断(伤害来源(), UnitTypeEthereal) == TRUE
       ├─ 则
       │    伤害: 触发单位()→伤害来源(): (伤害值() x 5.00) (AttackTypeChaos/DamageTypeUniversal)
       └─ 否则: (无)
```
...
动作
  └─ 如果
       ├─ 条件: 物品类型比较(物品类型ID(itemTSXJ), OperatorEqualENE, moon)
       ├─ 则
       │    如果
       │      ├─ 条件: 单位持有物品(uTianShuXiaJuan, itemTSXJ) == TRUE
       │      ├─ 则
       │      │    MoveLightningEx: lightTSXJ, AllowDontDont, 0.00, 0.00, 60.00, 0.00, 0.00, 60.00
       │      │    修改 uTianShuXiaJuan 的HeroStatStr: ModifyMethodSub(物品自定义值(itemTSXJ) x 10000)
       │      │    修改 uTianShuXiaJuan 的HeroStatAgi: ModifyMethodSub(物品自定义值(itemTSXJ) x 10000)
       │      │    修改 uTianShuXiaJuan 的HeroStatInt: ModifyMethodSub(物品自定义值(itemTSXJ) x 10000)
       ...
       │             │    修改 uTianShuXiaJuan 的HeroStatStr: ModifyMethodAdd10000
       │             │    修改 uTianShuXiaJuan 的HeroStatAgi: ModifyMethodAdd10000
       │             │    修改 uTianShuXiaJuan 的HeroStatInt: ModifyMethodAdd10000
       │             └─ 否则
       │                  MoveLightningEx: lightTSXJ, AllowDontDont, 0.00, 0.00, 60.00, 0.00, 0.00, 60.00
       │                  修改 uTianShuXiaJuan 的HeroStatStr: ModifyMethodSub(物品自定义值(itemTSXJ) x 10000)
       │                  修改 uTianShuXiaJuan 的HeroStatAgi: ModifyMethodSub(物品自定义值(itemTSXJ) x 10000)
...
动作
  ...
  └─ 如果
       ...
       └─ 否则
            ...
            清除点 pTemp
            如果
              ├─ 条件: 取模(单位自定义值(uShunZhuanQianNian), 5) == 0
              ├─ 则
              │    设置 pTemp = (uShunZhuanQianNian的位置)
              ...
              │      └─ CustomScriptCode: "call UnitDamageTargetBJ(udg_uShunZhuanQianNian,GetEnumUnit(),0.2*lv*(ll*3.4+m..."
              │    清除点 pTemp
              └─ 否则: (无)
```
...
动作
  ...
  └─ 如果
       ...
       │      ├─ 条件: iTemp == 1
       │      ├─ 则
       │      │    创建物品(指定坐标): 自定义代码("'I020'+GetRandomInt(0,255)"), 单位X坐标(触发单位()), 单位Y坐标(触发单位())
       │      └─ 否则
       │           如果
       │             ├─ 条件: iTemp == 2
       │             ├─ 则
       │             │    创建物品(指定坐标): 自定义代码("'I030'+GetRandomInt(0,255)"), 单位X坐标(触发单位()), 单位Y坐标(触发单位())
       │             └─ 否则
       │                  如果
       │                    ├─ 条件: iTemp == 3
       │                    ├─ 则
       │                    │    创建物品(指定坐标): 自定义代码("'I040'+GetRandomInt(0,255)"), 单位X坐标(触发单位()), 单位Y坐标(触发单位())
       │                    └─ 否则
       │                         如果
       │                           ├─ 条件: iTemp == 4
       │                           ├─ 则
       │                           │    创建物品(指定坐标): 自定义代码("'I050'+GetRandomInt(0,255)"), 单位X坐标(触发单位()), 单位Y坐标(触发单位())
       │                           └─ 否则: (无)
       │    PolledWait: 60.00
...
动作
  ...
  │    │    循环整数A 1→7: 显示文本(玩家)(玩家循环整数A(), 0, 0, "TRIGSTR_6582")
  │    │    返回
  │    └─ 否则: (无)
  ├─ 如果
  ...
  │    │    循环整数A 1→7: 显示文本(玩家)(玩家循环整数A(), 0, 0, "TRIGSTR_5181")
  │    │    返回
  │    └─ 否则: (无)
  ├─ 如果
  ...
  │    │    循环整数A 1→7: 显示文本(玩家)(玩家循环整数A(), 0, 0, "TRIGSTR_6584")
  │    │    返回
  │    └─ 否则: (无)
  ├─ 如果
  │    ├─ 条件: 全部成立
...
动作
  ...
  ├─ 删除计时器窗口 dNextWave
  ├─ 计时器窗口: tNextWave 标题="TRIGSTR_8181"
  ├─ 设置 dNextWave = 最后创建的计时器窗口()
  ├─ 关闭触发器 gg_trg_JinGongGuai
...
事件
  └─ 任意单位 - PlayerUnitEventHeroPickUpItem
条件
  └─ 物品类型比较(物品类型ID(被操作物品()), OperatorEqualENE, moon)
动作
  └─ 如果
       ├─ 条件: 全部成立
       │    ├─ 玩家在玩家组中((触发单位()的所有者), grpOnline) == TRUE
       ...
       │    PanCameraToTimed: 单位X坐标(uFuShenMoDi), 单位Y坐标(uFuShenMoDi), 0
       │    电影模式: OnOffOn, grpOnline
       │    TransmissionFromUnitWithNameBJ: bj_FORCE_ALL_PLAYERS, uFuShenMoDi, "TRIGSTR_381", SoundNull, "TRIGSTR_382", AddSetToAdd, 0, WaitDontWait
       │    TransmissionFromUnitWithNameBJ: bj_FORCE_ALL_PLAYERS, uFuShenMoDi, "TRIGSTR_2142", SoundNull, "TRIGSTR_2145", AddSetToAdd, 0, WaitDontWait
       │    TransmissionFromUnitWithNameBJ: bj_FORCE_ALL_PLAYERS, gg_unit_u003_0122, "TRIGSTR_5572", SoundNull, "TRIGSTR_5573", AddSetToAdd, 0, WaitDontWait
       │    TransmissionFromUnitWithNameBJ: bj_FORCE_ALL_PLAYERS, uFuShenMoDi, "TRIGSTR_5574", SoundNull, "TRIGSTR_5575", AddSetToAdd, 0, WaitDontWait
       │    TransmissionFromUnitWithNameBJ: bj_FORCE_ALL_PLAYERS, gg_unit_u003_0122, "TRIGSTR_5576", SoundNull, "TRIGSTR_5577", AddSetToAdd, 0, WaitDontWait
       │    电影模式: OnOffOff, grpOnline
       │    添加技能: gg_unit_ubon_0001, A03M
       │    添加技能: gg_unit_ubon_0001, A05Q
       │    添加技能: gg_unit_ubon_0001, A05W
